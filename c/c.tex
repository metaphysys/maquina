...
\section{Recursividad}
    ...
    \subsection{Tipos de recursividad}
        ...
        \subsubsection{Recursividad lineal}
            ...
            \paragraph{Recursividad lineal por la cola}

        \subsubsection{Recursividad múltiple}

    \subsection{Técnica divide y vencerás}

    \subsection{Técnica de vuelta atrás o backtracking}

        \subsubsection{Esquema general de estos algoritmos}
